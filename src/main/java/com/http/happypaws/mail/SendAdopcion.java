...
public class SendAdopcion {
    ...
    public void sendEmail(String nombreUsuario, String nombreMascota, String email, String imagen, String telefono) throws MailjetException, MailjetSocketTimeoutException {
        ...
        MailjetRequest request = new MailjetRequest(Emailv31.resource)
            .property(Emailv31.MESSAGES, new JSONArray()
                .put(new JSONObject()
                    ...
                    .put(Emailv31.Message.HTMLPART, "<html><body><div style=''><div><img src='" + header + "' alt='Happy Paws Logo' style='width: 100%; height: 5rem; position:fixed; top: 0;' /></div><div style='text-align: center;'><img src='" + logo + "' style='width: 250px;' /></div><div style='margin: 2rem 20%;'><p style='font-size: large; text-align: center; font-family: system-ui;'>Hola, has recibido la siguiente notificaci&oacute;n de <b>" + nombreUsuario + "<b>,</p><p style='font-size: large; text-align: center; font-family: system-ui;'><b>Estoy interesado en adoptar a " + nombreMascota + " mi direcci&oacute; de correo es: " + email + " y mi n&uacute;mero es: " + telefono + ".</b></p></div><div  style='text-align:center;'><img style='width: 10rem; border-radius: 100%; object-fit: cover; height: 10rem;' src=" + imagen + "><div/><div style='text-align: center; margin-bottom: 2rem;'></div></div><img src='" + footer + "' style='position:fixed; bottom: 0; height: 5rem; width: 100%;'/></body></html>")
