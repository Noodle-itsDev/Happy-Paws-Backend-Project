        ...
        MailjetRequest request = new MailjetRequest(Emailv31.resource)
            .property(Emailv31.MESSAGES, new JSONArray()
                .put(new JSONObject()
                    ...
                    .put(Emailv31.Message.HTMLPART, "<html><body><div style=''><div><img src='" + header + "' alt='Happy Paws Logo' style='width: 100%; height: 5rem; position:fixed; top: 0;' /></div><div style='text-align: center;'><img src='" + logo + "' style='width: 250px;' /></div><div style='margin: 2rem 20%;'><p style='font-size: large; text-align: center; font-family: system-ui;'>Hola <b>" + recipientName + "</b>,</p><p style='font-size: large; text-align: center; font-family: system-ui;'>Tu petici&oacute;n de voluntariado se ha generado con &eacute;	xito, proximanente validar&aacute;n tu solicitud y recibir&aacute;s la notificaci&oacute;n de cambio de estado.</p></div><div style='text-align: center; margin-bottom: 2rem;'></div></div><img src='" + footer + "' style='position:fixed; bottom: 0; height: 5rem; width: 100%;'/></body></html>")
