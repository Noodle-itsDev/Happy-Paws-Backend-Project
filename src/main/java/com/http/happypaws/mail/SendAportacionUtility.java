...
@Component
public class SendAportacionUtility {
    ...
    public void sendEmail(String email, String message) throws MailjetException, MailjetSocketTimeoutException {
